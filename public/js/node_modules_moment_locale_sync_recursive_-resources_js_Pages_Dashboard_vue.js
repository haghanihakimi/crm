(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_moment_locale_sync_recursive_-resources_js_Pages_Dashboard_vue"],{
...
/* harmony import */ var chartjs_plugin_zoom__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! chartjs-plugin-zoom */ "./node_modules/chartjs-plugin-zoom/dist/chartjs-plugin-zoom.esm.js");
/* harmony import */ var _heroicons_vue_24_outline__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @heroicons/vue/24/outline */ "./node_modules/@heroicons/vue/24/outline/UserGroupIcon.js");
...
/* harmony import */ var _heroicons_vue_24_outline__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @heroicons/vue/24/outline */ "./node_modules/@heroicons/vue/24/outline/CurrencyDollarIcon.js");
...
/* harmony import */ var _heroicons_vue_24_outline__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @heroicons/vue/24/outline */ "./node_modules/@heroicons/vue/24/outline/ArrowSmallUpIcon.js");
...
/* harmony import */ var _heroicons_vue_24_outline__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @heroicons/vue/24/outline */ "./node_modules/@heroicons/vue/24/outline/ArrowSmallDownIcon.js");
...
/* harmony import */ var _heroicons_vue_24_outline__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @heroicons/vue/24/outline */ "./node_modules/@heroicons/vue/24/outline/ShoppingBagIcon.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var drawCustomerChart = function drawCustomerChart() {
      var ctx = document.getElementById('customersChart').getContext('2d');
      var dates = [];
      var data = [];
      for (var i = 0; i < props.customers.customers.length; i++) {
        dates.push(moment__WEBPACK_IMPORTED_MODULE_1___default()(props.customers.customers[i].date).format('MMM D'));
    ...
    var drawSalesChart = function drawSalesChart() {
      var ctx = document.getElementById('salesChart').getContext('2d');
      var dates = [];
      var data = [];
      for (var i = 0; i < props.sales.sales.length; i++) {
        dates.push(moment__WEBPACK_IMPORTED_MODULE_1___default()(props.sales.sales[i].date).format('MMM D'));
        data.push("".concat(props.sales.sales[i].total));
      }
      new chart_js_auto__WEBPACK_IMPORTED_MODULE_2__["default"](ctx, {
        type: 'line',
        data: {
    ...
    var drawOrdersChart = function drawOrdersChart() {
    ...
    var chart = null;
    var drawViewAnalyticsChart = function drawViewAnalyticsChart() {
      var ctx = document.getElementById('viewAnalytics').getContext('2d');
      var dates = [];
      var customersData = [];
      var salesData = [];
      var ordersData = [];
      ...
      for (var _i = 0; _i < props.sales.sales.length; _i++) {
        salesData.push(props.sales.sales[_i].total);
      }
      for (var _i2 = 0; _i2 < props.orders.orders.length; _i2++) {
        ordersData.push(props.orders.orders[_i2].total);
      }
      chart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_2__["default"](ctx, {
        type: 'line',
        data: {
          labels: dates,
          datasets: [{
      ...
      chart_js_auto__WEBPACK_IMPORTED_MODULE_2__["default"].register(chartjs_plugin_zoom__WEBPACK_IMPORTED_MODULE_3__["default"]);
    };
    ...
    var __returned__ = {
      props: props,
      store: store,
      smallChartsOptions: smallChartsOptions,
      viewAnalyticsChartOptions: viewAnalyticsChartOptions,
      drawCustomerChart: drawCustomerChart,
      drawSalesChart: drawSalesChart,
      drawOrdersChart: drawOrdersChart,
      get chart() {
        return chart;
      },
      set chart(v) {
      ...
      drawViewAnalyticsChart: drawViewAnalyticsChart,
      resetZoom: resetZoom,
      get Layout() {
        return _Layouts_Dashboard__WEBPACK_IMPORTED_MODULE_0__["default"];
      },
      get computed() {
        return _vue_runtime_core__WEBPACK_IMPORTED_MODULE_5__.computed;
      },
      get onMounted() {
      ...
      get Chart() {
        return chart_js_auto__WEBPACK_IMPORTED_MODULE_2__["default"];
      },
      get zoomPlugin() {
        return chartjs_plugin_zoom__WEBPACK_IMPORTED_MODULE_3__["default"];
      },
      get Customers() {
...
var _hoisted_32 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", {
  "class": "w-full text-left capitalize text-smooth-black tracking-wider text-lg capitalize font-semibold py-4"
}, " financial analysis ", -1 /* HOISTED */);
var _hoisted_33 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("canvas", {
  id: "viewAnalytics",
  width: "400"
}, null, -1 /* HOISTED */);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["Layout"], {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" All errors and messages from other pages which are redirected to this page after submission "), $props.flash.message ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", {
        "class": "relative block w-full text-left text-black font-medium rounded p-4 bg-orange bg-opacity-5 p-2 border border-orange",
        innerHTML: $props.flash.message
      }, null, 8 /* PROPS */, _hoisted_3)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Number of customers statics box "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Heading row "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Sales icon box "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["Customers"], {
        "class": "w-6 h-6 text-sm text-black"
      })]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Sales statics bar box "), _hoisted_8]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Total sale and percentage box "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", _hoisted_10, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.customers.customerCounter <= 9 ? "0".concat($props.customers.customerCounter) : $props.customers.customerCounter), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_11, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", _hoisted_12, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.customers.customers <= 1 ? 'Customer' : 'Customers'), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", _hoisted_13, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.customers.avStatus === 'positive' ? $props.customers.average.toFixed(1) : "-".concat($props.customers.average.toFixed(1))) + "% ", 1 /* TEXT */), $props.customers.avStatus === 'positive' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["Increased"], {
        key: 0,
        "class": "w-4 h-4 text-sm"
      })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $props.customers.avStatus === 'negative' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["Decreased"], {
        key: 1,
        "class": "w-4 h-4 text-sm"
      })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Sales statics box "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_14, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Heading row "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_15, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Sales icon box "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_16, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["Money"], {
        "class": "w-6 h-6 text-sm text-smooth-black"
      })]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Sales statics bar box "), _hoisted_17]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Number of Sales and percentage box "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_18, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", _hoisted_19, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.sales.salesCounter <= 9 ? "0".concat($props.sales.salesCounter) : $props.sales.salesCounter), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_20, [_hoisted_21, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", _hoisted_22, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.sales.avStatus === 'positive' ? $props.sales.average.toFixed(1) : "-".concat($props.sales.average.toFixed(1))) + "% ", 1 /* TEXT */), $props.sales.avStatus === 'positive' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["Increased"], {
        key: 0,
        "class": "w-4 h-4 text-sm"
      })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $props.sales.avStatus === 'negative' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["Decreased"], {
        key: 1,
        "class": "w-4 h-4 text-sm"
      })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Orders statics box "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_23, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Heading row "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_24, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Orders icon box "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_25, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["Orders"], {
        "class": "w-6 h-6 text-sm text-smooth-black"
      })]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Orders statics bar box "), _hoisted_26]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Number of Orders and percentage box "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_27, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", _hoisted_28, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.orders.ordersCounter <= 9 ? "0".concat($props.orders.ordersCounter) : $props.orders.ordersCounter), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_29, [_hoisted_30, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", _hoisted_31, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.orders.avStatus === 'positive' ? $props.orders.average.toFixed(1) : "-".concat($props.orders.average.toFixed(1))) + "% ", 1 /* TEXT */), $props.orders.avStatus === 'positive' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["Increased"], {
        key: 0,
        "class": "w-4 h-4 text-sm"
      })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $props.orders.avStatus === 'negative' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["Decreased"], {
        key: 1,
        "class": "w-4 h-4 text-sm"
      })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Google analytics traffic statistics container "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
        "class": "w-full h-auto mt-2 flex flex-row flex-wrap pb-8 px-4"
      }, [_hoisted_32, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Website users statistics "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
...
;
const __exports__ = /*#__PURE__*/(0,C_GitHub_crm_laravel_vue_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_Dashboard_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_Dashboard_vue_vue_type_template_id_097ba13b__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/Pages/Dashboard.vue"]])
/* hot reload */
if (false) {}
