                    ...
                    @submit.prevent="createBrand">
                        ...
                        <div class="w-full relative flex flex-row flex-wrap gap-4">
                            <div class="w-full relative flex-1">
                                ...
                                :disabled="newBrandForm.processing" />
                            </div>
                        ...
                        <div class="w-full relative flex flex-row flex-wrap gap-4">
                            <div class="w-full relative flex-1">
                                ...
                                id="logo" 
                                @input="newBrandForm.logo = $event.target.files[0]"
                                type="file"
                        ...
                        <div class="w-full relative flex flex-row flex-wrap gap-4">
                            <div class="w-full relative flex-1">
                                ...
                                v-model="newBrandForm.description" 
                                :disabled="newBrandForm.processing">
                                </textarea>
                            </div>
                        ...
                        <div class="select-none w-full relative flex flex-row flex-wrap gap-4">
                            ...
                            type="submit" 
                            role="button"
                            :disabled="newBrandForm.processing || !newBrandForm.isDirty"/>
                        </div>
...
<script setup>
    ...
    const createBrand = () => {
        if (!newBrandForm.processing) {
            newBrandForm.post(route('brands.create.new'))
        }
    }
    
    watch(() => newBrandForm.name,
