<template>
    <div class="select-none w-auto min-w-[300px] max-w-[300px] h-full relative bg-white-fc border-r border-black border-opacity-5">
        <!-- Profile Controller -->
        ...
        <div v-if="$page.props.auth.user && !$page.props.auth.user.default_password" class="w-full h-full absolute top-0 left-0 pt-[94px] z-0">
            <div class="w-full h-full px-4 overflow-auto overflow-x-hidden">
                ...
                <Disclosure v-if="$page.props.abilities.canReadCustomers || $page.props.abilities.canCreateCustomers" v-slot="{ open }">
                    <DisclosureButton
                    class="no-highlight flex w-full justify-between rounded-lg bg-purple-100 px-0 py-3 text-left text-sm font-medium text-purple-900 hover:bg-purple-200 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                        <Span class="w-full flex flex-row gap-0 text-md">
                            Customers
                    ...
                    leave-to-class="transform opacity-0">
                        <DisclosurePanel class="p-0 border-b border-black border-opacity-5">
                            <Hyperlink v-if="$page.props.abilities.canReadCustomers" :value="'View Customers'" :link="route('customers.view')" />
                            <Hyperlink v-if="$page.props.abilities.canCreateCustomers" :value="'Add Customer'" :link="route('customers.new.view')" />
                        </DisclosurePanel>
                    </transition>
                </Disclosure>
                <!-- Sidebar - Brands links -->
                <Disclosure v-if="$page.props.abilities.canReadBrands || $page.props.abilities.canCreateBrands" v-slot="{ open }">
                    <DisclosureButton
                    class="no-highlight flex w-full justify-between rounded-lg bg-purple-100 px-0 py-3 text-left text-sm font-medium text-purple-900 hover:bg-purple-200 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                        <Span class="w-full flex flex-row gap-0 text-md">
                            Brands
                    ...
                    leave-to-class="transform opacity-0">
                        <DisclosurePanel class="p-0 border-b border-black border-opacity-5">
                            <Hyperlink v-if="$page.props.abilities.canReadBrands" :value="'View Brands'" :link="route('brands.list.view')" />
                            <Hyperlink v-if="$page.props.abilities.canCreateBrands" :value="'Create Brand'" :link="route('brands.create.new')" />
                        </DisclosurePanel>
                    </transition>
                </Disclosure>
                <!-- Sidebar - Products links -->
                <Disclosure v-if="$page.props.abilities.canReadProducts || $page.props.abilities.canCreateProducts" v-slot="{ open }">
                    <DisclosureButton
                    class="no-highlight flex w-full justify-between rounded-lg bg-purple-100 px-0 py-3 text-left text-sm font-medium text-purple-900 hover:bg-purple-200 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                        <Span class="w-full flex flex-row gap-0 text-md">
                            Products
                    ...
                    leave-to-class="transform opacity-0">
                        <DisclosurePanel class="p-0 border-b border-black border-opacity-5">
                            <Hyperlink v-if="$page.props.abilities.canReadProducts" :value="'View Products'" :link="route('product.view.list')" />
                            <Hyperlink v-if="$page.props.abilities.canCreateProducts" :value="'Create Product'" :link="route('product.create.view')" />
                        </DisclosurePanel>
                    </transition>
                </Disclosure>
                <!-- Sidebar - Invoices links -->
                <Disclosure v-if="$page.props.abilities.canReadInvoices || $page.props.abilities.canCreateInvoices" v-slot="{ open }">
                    <DisclosureButton
                    class="no-highlight flex w-full justify-between rounded-lg bg-purple-100 px-0 py-3 text-left text-sm font-medium text-purple-900 hover:bg-purple-200 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                        <Span class="w-full flex flex-row gap-0 text-md">
                            Invoices
